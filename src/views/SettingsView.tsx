    ...
    <div className="p-8 h-full overflow-y-auto bg-gray-50 text-gray-900">
      <div className="flex items-center mb-6">
        ...
        <div>
          ...
          <p className="text-gray-500 mt-1">Configure peripherals and manage local data</p>
        </div>
      </div>
        ...
        <section className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
          ...
          <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-200">
            <div>
              ...
              <p className="text-sm font-mono text-gray-500 mt-1">Status: {deviceStatus}</p>
            </div>
            <button 
              onClick={testPrint}
              className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg flex items-center font-medium transition-colors"
            >
        ...
        <section className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
          ...
          <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg mb-6">
            <p className="text-yellow-800 text-sm">
              <strong className="block mb-1">Offline-First Privacy Guarantee</strong>
          ...
          <button 
            ...
            className="w-full px-4 py-3 bg-red-50 hover:bg-red-100 text-red-700 border border-red-200 rounded-lg flex items-center justify-center font-bold transition-colors mt-4"
          >
